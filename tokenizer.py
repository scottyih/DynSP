...
#import marisa_trie
import sys,io,tempfile,string,time
import codecs
...
if __name__ == '__main__':
    print(simpleTokenize("I love to have +1000,000 dollars! https://twitter.com/asba hehe : @noath kills me!) adsfa"))
    print(simpleTokenize("I love to have $1000,000 dollars! #cool"))
